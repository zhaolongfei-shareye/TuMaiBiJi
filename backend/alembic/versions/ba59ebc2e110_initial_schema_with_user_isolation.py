...
def upgrade() -> None:
    ...
    op.add_column('notes', sa.Column('user_id', sa.String(length=100), nullable=False))
    op.add_column('notes', sa.Column('key_links', sa.JSON(), nullable=True))
    ...
    op.add_column('notes', sa.Column('cover_asset_id', sa.Integer(), nullable=True))
    op.add_column('notes', sa.Column('is_pinned', sa.Boolean(), nullable=False))
    op.add_column('notes', sa.Column('pinned_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('notes', sa.Column('version', sa.Integer(), nullable=False))
    op.alter_column('notes', 'summary',
               existing_type=sa.TEXT(),
               nullable=True)
    op.create_index(op.f('ix_notes_user_id'), 'notes', ['user_id'], unique=False)
    op.create_foreign_key(None, 'notes', 'categories', ['category_id'], ['id'])
    op.create_foreign_key(None, 'notes', 'assets', ['cover_asset_id'], ['id'])
...
def downgrade() -> None:
    ...
    op.drop_column('notes', 'cover_asset_id')
    op.drop_column('notes', 'category_id')
    op.drop_column('notes', 'content')
    op.drop_column('notes', 'key_links')
